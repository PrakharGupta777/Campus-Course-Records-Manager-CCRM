...
public class Course {
    ...
    public Course(String code, String title, int credits, String instructor, String department, String semester) {
        ...
        this.instructor = instructor == null ? "TBD" : instructor;
        this.department = department == null ? "General" : department;
        this.semester = semester == null ? "Unknown" : semester;
        this.active = true;
    }
    ...
    public String toString() {
        return code + " - " + title + " (" + credits + "cr) [" + instructor + "] Dept: " +
                department + " | Sem: " + semester + " | Active: " + active;
    }
